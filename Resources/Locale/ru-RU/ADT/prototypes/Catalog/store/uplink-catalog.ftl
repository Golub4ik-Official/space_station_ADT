...
uplink-bodybag-syndicate-name = Коробка мешков Синдиката
uplink-bodybag-syndicate-desc = Содержит 2 мешка для транспортировки заключённых в раскраске Синдиката. Идеально подходит для похищения людей или избавления от тел.
