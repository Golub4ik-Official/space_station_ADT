...
health-examinable-carbon-Asphyxiation-8 = [color=lightblue]{ CAPITALIZE(POSS-ADJ($target)) } дыхание слегка затруднено.[/color]
health-examinable-carbon-Asphyxiation-15 = [color=lightblue]{ CAPITALIZE(SUBJECT($target)) } { CONJUGATE-HAVE($target) } одышку.[/color]
health-examinable-carbon-Asphyxiation-30 = [color=lightblue]{ CAPITALIZE(POSS-ADJ($target)) } губы синеют.[/color]
health-examinable-carbon-Asphyxiation-50 = [color=lightblue]{ CAPITALIZE(SUBJECT($target)) } с трудом дышит.[/color]
health-examinable-carbon-Asphyxiation-75 = [color=lightblue]{ CAPITALIZE(POSS-ADJ($target)) } лицо синеет.[/color]
health-examinable-carbon-Asphyxiation-100 = [color=lightblue]{ CAPITALIZE(SUBJECT($target)) } задыхается![/color]
health-examinable-carbon-Asphyxiation-200 = [color=lightblue]{ CAPITALIZE(SUBJECT($target)) } не дышит![/color]
